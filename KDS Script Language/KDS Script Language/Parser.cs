...
namespace KDS_Script_Language
{
    public static class Parser
    {
        ...
        private static List<TokenBase> currentTokens;
        private static string currentClassName;

        private static ASTNode ParseFunctionCallOrParameterAccess(string scope)
        {
...
//                currentToken++;
        ...
        private static List<ASTNode> ParseCodeBlockOrSingleLineStatement()
        {
        ...
        private static List<ASTNode> ParseFunctionParameter()
        {
            if (currentTokens[currentToken].Token == "(")
            {
                currentToken++;
